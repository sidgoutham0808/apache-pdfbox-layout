...
public class GenUtils {
    ...
    public static PDImageXObject createTuxImage() throws IOException {
        final byte[] tuxBytes = IOUtils.toByteArray(Objects.requireNonNull(GenUtils.class.getClassLoader().getResourceAsStream("tux.png")));
    ...
    public static PDImageXObject createGliderImage() throws IOException {
        final byte[] gliderBytes = IOUtils.toByteArray(Objects.requireNonNull(GenUtils.class.getClassLoader().getResourceAsStream("glider.png")));
    ...
    public static PDImageXObject createSampleImage() throws IOException {
        final byte[] sampleBytes = IOUtils.toByteArray(Objects.requireNonNull(GenUtils.class.getClassLoader().getResourceAsStream("sample.png")));
