 ...
 * custom strategy for breaking words. By default the {@link WordBreakers.DefaultWordBreaker}
 * is used. Another predefined word breaker is the
 * {@link WordBreakers.NonBreakingWordBreaker} which may be used to get the legacy behavior.
...
public class WordBreakerFactory {
     ...
     */
    public final static String DEFAULT_WORD_BREAKER_CLASS_NAME = WordBreakers.DefaultWordBreaker.class
	    .getName();
    
    /**
     * class name of the (legacy) non-breaking word breaker.
     */
    public final static String LEGACY_WORD_BREAKER_CLASS_NAME = WordBreakers.NonBreakingWordBreaker.class
	    .getName();

    private final static WordBreaker DEFAULT_WORD_BREAKER = new WordBreakers.DefaultWordBreaker();
