...
public class Indent extends ControlFragment {
    ...
    protected LayoutStyledText layoutStyledText;
	...
	layoutStyledText = new LayoutStyledText(label, getFontDescriptor(), getColor(), 0,
	...
	layoutStyledText = new LayoutStyledText("", getFontDescriptor(), getColor(), 0,
		indentPt, 0);
    }
	...
	return layoutStyledText.getWidth();
    }

    /**
     * @return a styled text representation of the indent.
     */
    public LayoutStyledText toStyledText() {
	return layoutStyledText;
    }

    @Override
    public String toString() {
	return "ControlFragment [" + getName() + ", " + layoutStyledText + "]";
    }
