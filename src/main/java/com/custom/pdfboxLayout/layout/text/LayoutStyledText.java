 ...
 */
public class LayoutStyledText implements TextFragment {
     ...
     *            the font to use.
     */
    public LayoutStyledText(final String text, final float size, final PDFont font) {
     ...
     *            the font to use.
     */
    public LayoutStyledText(final String text, final FontDescriptor fontDescriptor) {
    ...
    public LayoutStyledText inheritAttributes(String text) {
	return inheritAttributes(text, getLeftMargin(), getRightMargin());
    }

    public LayoutStyledText inheritAttributes(String text, float leftMargin,
                                              float rightMargin) {
	return new LayoutStyledText(text, getFontDescriptor(), getColor(),
