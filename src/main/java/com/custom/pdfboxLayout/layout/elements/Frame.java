...
import com.custom.pdfboxLayout.layout.shape.Rect;
import com.custom.pdfboxLayout.layout.text.DrawListener;
import com.custom.pdfboxLayout.layout.text.Position;
import com.custom.pdfboxLayout.layout.text.WidthRespecting;
...
public class Frame implements Element, Drawable, WidthRespecting, Dividable {
    ...
    private com.custom.pdfboxLayout.layout.shape.Shape shape = new Rect();
     ...
     */
    public com.custom.pdfboxLayout.layout.shape.Shape getShape() {
	return shape;
    }
     ...
     *            the shape to use.
     */
    public void setShape(com.custom.pdfboxLayout.layout.shape.Shape shape) {
	this.shape = shape;
    }
