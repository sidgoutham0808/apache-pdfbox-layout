package com.custom.pdfboxLayout.util;
...
import static com.custom.pdfboxLayout.util.FloatUtil.isEqualInEpsilon;
...
public final class PdfUtil {
    ...
    private static float getWidthOfStringWithoutNewlines(String text, PDFont font, int fontSize) throws IOException {
